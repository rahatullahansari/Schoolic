            ...
            if (filter_var($email, FILTER_VALIDATE_EMAIL))
            {
                if ($password1 == $password2)
                {
                    ...
                    if (mysqli_num_rows($data) == 0)
                    {
                        ...
                        $query = "INSERT INTO hm_profile(hm_id, first_name, id_proof, password, profile_type, mobile_no1, about_me, date_of_join) VALUES" . "( 0, '$first_name', '$id_proof', SHA('$password1'), 4, '$mobile_1', '$description', '$now')";
                    ...
                    {
                        $home_url = 'http://' . $_SERVER['HTTP_HOST'] . '/Work%20Space/Schoolic/school_confirmation.php';
        ...
        <fieldset style="border:solid; border-width:2px; border-color:#39F; border-radius:13px; box-shadow:2px 4px 9px #FFFFFF; background-color:#D7E4FF; opacity:0.8; margin-top:-5px; width:600px;">
          ...
          <table>
            ...
            <tr>
              ...
              <td align="right">
                <input type="password" name="password1" id="password" title="Enter a password for this School page" placeholder="Password for School page" style="width:250px" required>
              </td>
            </tr>
            <tr>
            </tr>
            <tr>
              ...
              <td align="right">
                <input type="password" name="password2" id="password" title="Enter a Confirm password for this School page" placeholder="Confirm Password for School page" style="width:250px" required>
              </td>
            </tr>
            <tr>
            </tr>
          ...
          <fieldset style="border:solid; border-width:1.5px; border-color:#69F; border-radius:9px; background-color:#E6EEFF; opacity:0.8; margin-top:-5px;">
            ...
            <table>
              ...
              <tr>
                <td align="left">
                  <label for="description">Give description about your School page:
                  </label>
                </td>
                <td align="left">
                  <input name="description" type="input" id="descript" title="It will be helpfull for profile visitors to identify your School page." placeholder="Briefly discribe about your School page." maxlength="100" style="margin-top:10px; width:250px;" >
                </td>
              </tr>
            </table>
          </fieldset>
