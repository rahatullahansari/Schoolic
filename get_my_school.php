...
if($all_friends->num_rows)
{
	while($msg_row = $all_friends->fetch_array(MYSQLI_ASSOC))
	{
		...
		*/
		...
		$f_info = queryMysql("SELECT hm_id, first_name FROM hm_profile WHERE hm_id = $f_id AND profile_type = 4");
		if($f_info->num_rows)
		{
...
?>
			...
			<a href="../profile/pro.php?user_id=<?php echo $f_id/2+5; ?>" class="w3-btn-block w3-theme-l1 w3-left-align">
              <i class="fa fa-home fa-fw w3-margin-right">
              </i> Goto your <?php echo $f_row['first_name'];?>
            </a>
<?php
			}
		}
	...
	echo "<p align='center' style='color:blue;'>You are not added to any School.</p>";
}
?>
