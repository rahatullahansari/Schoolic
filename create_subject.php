            ...
            if (filter_var($email, FILTER_VALIDATE_EMAIL))
            {
                if ($password1 == $password2)
                {
                    ...
                    if (mysqli_num_rows($data) == 0)
                    {
                        ...
                        $query = "INSERT INTO hm_profile(hm_id, first_name, id_proof, password, profile_type, mobile_no1, about_me, date_of_join) VALUES" . "( 0, '$first_name', '$id_proof', SHA('$password1'), 6, '$mobile_1', '$description', '$now')";
                    ...
                    {
                        $home_url = 'http://' . $_SERVER['HTTP_HOST'] . '/Work%20Space/Schoolic/subject_confirmation.php';
