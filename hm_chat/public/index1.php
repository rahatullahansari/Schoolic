	...
	<div class="container-4">
		<div class="msg-wgt-header-4">
			<a id="select_chat_box4" href="index.php?reciver_id=<?php echo $r_c_r_id[5]/2+5; ?>&amp;swap_id=4">
				...
				<span><?php echo $header_name[5]; ?></span>
			</a>
			<a style="float:right;" href="index.php?reciver_id=<?php echo $r/2+5; ?>&amp;close_chat_id=4">X</a>
		</div>
	</div>
<?php 
}
	...
	<div class="container-3">
		<div class="msg-wgt-header-3">
			<a id="select_chat_box3" href="index.php?reciver_id=<?php echo $r_c_r_id[4]/2+5; ?>&amp;swap_id=3">
				...
				<span><?php echo $header_name[4]; ?></span>
			</a>
			<a style="float:right;" href="index.php?reciver_id=<?php echo $r/2+5; ?>&amp;close_chat_id=3">X</a>
		</div>
	</div>
<?php 
}
	...
	<div class="container-2">
		<div class="msg-wgt-header-2">
			<a id="select_chat_box2" href="index.php?reciver_id=<?php echo $r_c_r_id[3]/2+5; ?>&amp;swap_id=2">
				...
				<span><?php echo $header_name[3]; ?></span>
			</a>
			<a style="float:right;" href="index.php?reciver_id=<?php echo $r/2+5; ?>&amp;close_chat_id=2">X</a>
		</div>
	</div>
<?php 
}
	...
	<div class="container-1">
		<div class="msg-wgt-header-1">
			<a id="select_chat_box1" href="index.php?reciver_id=<?php echo $r_c_r_id[2]/2+5; ?>&amp;swap_id=1">
				...
				<span><?php echo $header_name[2]; ?></span>
			</a>
			<a style="float:right;" href="index.php?reciver_id=<?php echo $r/2+5; ?>&amp;close_chat_id=1">X</a>
		</div>
	</div>
<?php 
}?>
  <span id="msg_show"></span><input type="hidden" id="msg_show1" /><input type="hidden" id="msg_show2" />
    ...
    <div class="container">
      <div class="msg-wgt-header">
        ...
        <span><?php echo $hm_info['first_name'] ." ". $hm_info['last_name']; ?></span>
		<?php if($not_last == 1){ ?>
			<a href="index.php?reciver_id=<?php echo $r_c_r_id[2]/2+5; ?>&amp;close_chat_id=0" style="float:right; margin:6px;">X</a>
		<?php }elseif($not_last == 0){ ?>
			<a href="index.php?reciver_id=<?php echo 0/2+5; ?>&amp;close_chat_id=0" onClick="parent.reciverZero()" style="float:right; margin:6px;">X</a>
		<?php }?>
      </div>
...
MSG;
      ...
      <div class="msg-wgt-footer">
	  	<table width="100%">
			<tr>
				<td>
					<textarea id="chatMsg" onClick="setTimeout(scrollDown(),500)" placeholder="Type your message. Press shift + Enter to send" autofocus></textarea>
					<div id="for_pic_msg" style="display:none;">
						<form action="<?php echo $_SERVER['PHP_SELF'];?>" method="post" enctype="multipart/form-data">
							<table width="100%">
								<tr>
									<td>
										<textarea id="pic_caption" onClick="setTimeout(scrollDown(),500)" name="pic_caption" placeholder="Type caption for this attachment."></textarea>
									</td>
								</tr>
								<tr>
									<td onClick="setTimeout(scrollDown(),500)" >
										<br/>
										Upload: <label id="chat_pic_select" title="Upload Picture"><img src="../../images/icon/1456538209_free-34.png" width="15" />
											<input type="file" name="chat_pic" id="chat_pic" style="display:none;" />
										</label>
										<label id="chat_audio_select" title="Upload Audio"><img src="../../images/icon/1456538332_Microphone.png" width="15" />
											<input type="file" name="chat_audio" id="chat_audio" style="display:none;" />
										</label>
										<label id="chat_video_select" title="Upload Video"><img src="../../images/icon/1456538481_youtube.png" width="15" />
											<input type="file" name="chat_video" id="chat_video" style="display:none;" />
										</label>
										<label id="chat_file_select" title="Upload File"><img src="../../images/icon/file.png" width="15" />
										...
										<label style="float:right; cursor:pointer;" title="Send" ><img src="../../images/icon/1456537048_send.png" width="20"/>
				...
				<td>
					<label id="for_pic_box" onClick="display_pic_box()" style="border:#A6D2FF 1px solid; padding:8px; float:right; cursor:pointer;" onClick="setTimeout(scrollDown(),500)" title="Click to attach media file"><img src="../../images/icon/1456539170_Iconfinder_0039_15.png" width="20"/>
					</label>
					<label id="for_text_box" onClick="display_text_box()" style="border:#A6D2FF 1px solid; padding:8px; display:none; float:right; cursor:pointer;" title="Click to text chat"><img src="../../images/icon/1456538612_EditDocument.png" width="20"/>
					</label>
				</td>
			</tr>
		</table>
	...
	<div id="popup1" class="overlay">
		<div class="popup">
			<h2></h2>
			<a href="index.php?reciver_id=<?php echo ($_SESSION['reciver_id'])/2+5; ?>" class="close" onClick="close_box('popup1')">&times;</a>
			<br>
			<div class="content">
	...
	<div id="popup2" class="overlay">
		<div class="popup11">
			<h2></h2>
			<a href="index.php?reciver_id=<?php echo ($_SESSION['reciver_id'])/2+5; ?>" class="close" onClick="close_box('popup2')">&times;</a>
			<br>
			<div class="content">
