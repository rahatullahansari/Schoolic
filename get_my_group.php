...
if($all_friends->num_rows)
{
	while($msg_row = $all_friends->fetch_array(MYSQLI_ASSOC))
	{
		...
		*/
		...
		$f_info = queryMysql("SELECT hm_id, first_name FROM hm_profile WHERE hm_id = $f_id AND profile_type = 5");
		if($f_info->num_rows)
		{
...
<?php
	...
	echo "<p align='center' style='color:blue;'>You are not added to any Group.</p>";
}
?>
